...
# room_list = [
#     {'id': 1 , 'name': 'Lets learn dyango!'},
#     {'id': 2 , 'name': 'Lets play mobile legendssss!'},
...
def room(request, pk):
    ...
    room_messages = room_list.message_set.all()
    ...
    context = {'rooms': room_list, 'room_messages': room_messages,'participants': participants}
